				...
				<div className="row lg-marg">
					...
					<div className="col-lg-6 content valign">
						<div className="full-width">
							<div className="cluom mb-40 current" data-tab="tab-1">
								<div className="info d-flex align-items-end">
									<h4>
										<span className="mr-10 fz-16">01.</span>
										<a href="project-details.html">Iridescent Wallpapers</a>
									</h4>
							...
							<div className="cluom mb-40" data-tab="tab-2">
								<div className="info d-flex align-items-end">
									<h4>
										<span className="mr-10 fz-16">02.</span>
										<a href="project-details.html">Proof Template</a>
									</h4>
							...
							<div className="cluom mb-40" data-tab="tab-3">
								<div className="info d-flex align-items-end">
									<h4>
										<span className="mr-10 fz-16">03.</span>
										<a href="project-details.html">Ledge Phone</a>
									</h4>
							...
							<div className="cluom mb-40" data-tab="tab-4">
								<div className="info d-flex align-items-end">
									<h4>
										<span className="mr-10 fz-16">04.</span>
										<a href="project-details.html">Frame Sans</a>
									</h4>
							...
							<div className="cluom" data-tab="tab-5">
								<div className="info d-flex align-items-end">
									<h4>
										...
										<a href="project-details.html">Modern Minimalist</a>
									</h4>
